...
namespace IO.Swagger.Model
{
    ...
    public partial class ConditionalRes : IEquatable<ConditionalRes>, IValidatableObject
    {
        ...
        public ConditionalRes(string stopOrderId = default(string), decimal? userId = default(decimal?), string stopOrderStatus = default(string), string symbol = default(string), string side = default(string), string orderType = default(string), decimal? price = default(decimal?), decimal? qty = default(decimal?), string timeInForce = default(string), string stopOrderType = default(string), decimal? basePrice = default(decimal?), decimal? stopPx = default(decimal?), string orderLinkId = default(string), string createdAt = default(string), string updatedAt = default(string))
        {
