...
namespace IO.Swagger.Model
{
    ...
    public partial class LinearListStopOrderResult :  IEquatable<LinearListStopOrderResult>, IValidatableObject
    {
        ...
        public LinearListStopOrderResult(string stopOrderId = default(string), long? userId = default(long?), string side = default(string), string symbol = default(string), string orderType = default(string), decimal? price = default(decimal?), decimal? qty = default(decimal?), string timeInForce = default(string), string orderStatus = default(string), decimal? triggerPrice = default(decimal?), string orderLinkId = default(string), string createdAt = default(string), string updatedAt = default(string), decimal? takeProfit = default(decimal?), decimal? stopLoss = default(decimal?), string tpTriggerBy = default(string), string slTriggerBy = default(string))
        {
