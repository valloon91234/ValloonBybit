...
namespace IO.Swagger.Model
{
    ...
    public partial class SymbolTickInfo :  IEquatable<SymbolTickInfo>, IValidatableObject
    {
        ...
        public SymbolTickInfo(string symbol = default, decimal? bidPrice = default, decimal? askPrice = default, decimal? lastPrice = default, string lastTickDirection = default, decimal? prevPrice24h = default, decimal? price24hPcnt = default, decimal? highPrice24h = default, decimal? lowPrice24h = default, decimal? prevPrice1h = default, decimal? price1hPcnt = default, decimal? markPrice = default, decimal? indexPrice = default, decimal? openInterest = default(decimal?), string openValue = default, string totalTurnover = default, string turnover24h = default, decimal? totalVolume = default(decimal?), decimal? volume24h = default(decimal?), string fundingRate = default, string predictedFundingRate = default, string nextFundingTime = default, decimal? countdownHour = default(decimal?))
        {
            this.Symbol = symbol;
