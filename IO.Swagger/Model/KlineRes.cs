...
namespace IO.Swagger.Model
{
    ...
    public partial class KlineRes : IEquatable<KlineRes>, IValidatableObject
    {
        ...
        public KlineRes(string symbol = default, string interval = default, decimal? openTime = default, decimal? open = default, decimal? high = default, decimal? low = default, decimal? close = default, decimal? volume = default)
        {
            this.Symbol = symbol;
